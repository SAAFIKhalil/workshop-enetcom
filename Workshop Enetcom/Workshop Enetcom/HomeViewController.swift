...
extension HomeViewController : UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let placeDetailViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "PlaceDetailViewController") as! PlaceDetailViewController
...
class HomeViewController: UIViewController {
    ...
    var placesList : [ PlaceModel] = [ PlaceModel(title: "Bizerte",image:"Bizerte" ,distance: "400", categorie: "tourisme"), PlaceModel(title: "Tunis",image:"Tunis",distance: "300", categorie: "tourisme"),PlaceModel(title: "Touzeur",image:"Touzeur",distance: "200", categorie: "tourisme"),PlaceModel(title: "Sousse",image:"Sousse", distance: "150", categorie: "tourisme")]
